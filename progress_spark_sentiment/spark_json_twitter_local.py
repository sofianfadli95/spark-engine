...
while(1):
    try:
        ...
        kafkaStream = KafkaUtils.createDirectStream(ssc, topics = ['twitter-stream'], kafkaParams = {"metadata.broker.list": "192.168.56.102:9092"}, keyDecoder=utf8_decoder, valueDecoder=utf8_decoder,
                                   messageHandler=None)
        ...
        rdd_tot.saveAsTextFiles("file:///{}/{}/result_{}.json".format(file_path,date_time,timestr))
